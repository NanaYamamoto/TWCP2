...
<div class="row">
    <form action="{{route('admin.user.regist.confirm')}}" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group form-inline" style="margin-top:10px;">
            <a href="{{route('admin.user')}}" class="btn btn-secondary">一覧に戻る</a>
        </div>
    </form>
</div>
