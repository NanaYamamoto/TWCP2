...
<div id="profile-edit-form" class="container" style="grid-template-columns:none;">
    ...
    <div class="row">
        <div class="bg-white"><!-- col-10 -->
            ...
            <form method="POST" action="{{ route('member.post.profile_proc') }}" class="p-5" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-0 mt-3 text-center">
                    <a href="{{route('member.post.profile')}}" class="btn btn-block btn-secondary mt-2">プロフィール画面に戻る</a>
                </div>
            </form>
        </div>
    </div>
