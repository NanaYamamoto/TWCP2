...
@foreach( $rows as $row )
                <tr>
                    ...
                    <td>
                        <a href="{{route('category.details', $row->id)}}" class="btn btn-outline-primary">詳細</a>
                        <a href="{{route('category.update', $row->id)}}" class="btn btn-outline-primary">編集</a>
                        <a href="{{route('category.delete.confirm', $row->id)}}" class="btn btn-outline-primary">削除</a>
                    </td>
                </tr>
@endforeach
            </thead>
