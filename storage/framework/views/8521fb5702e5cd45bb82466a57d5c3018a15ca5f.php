                        ...
                        <li class="list-index__item" data-article-index-item="true">
                            <a href="#" target="_blank" rel="noopener" class="list-index__target" data-article-index-item-elem="link" data-fetch-link="true">
                                <figure class="list-index__image">
                                    <img width="890" height="650" src="/storage/members/<?php echo e($row->user->icon_url); ?>" class="attachment- size- wp-post-image" alt="" loading="lazy" data-article-index-item-elem="image" sizes="(max-width: 890px) 100vw, 890px"> <span class="list-index__image-icon">
                                ...
                                <div class="list-index__title" data-article-index-item-elem="title"><?php echo e($row->user->name); ?></div>
                                <div class="list-index__time">
                                    <time datetime="2021-10-04T09:03"><?php echo e($row->created_at); ?></time>
                                </div>
                            </a>
...
<?php echo $__env->make('layouts.team.team', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/TWCP2/resources/views/admin/post/list.blade.php ENDPATH**/ ?>