...
<?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('operate.members.detail', $row->id)); ?>" class="btn btn-outline-primary">詳細</a>
                        <a href="<?php echo e(route('operate.members.update', $row->id)); ?>" class="btn btn-outline-primary">編集</a>
                        <a href="<?php echo e(route('operate.members.delete.confirm', $row->id)); ?>" class="btn btn-outline-primary">削除</a>
                    </td>
                </tr>
...
<?php echo $__env->make('sample.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/TWCP2/resources/views/operate/members/list.blade.php ENDPATH**/ ?>