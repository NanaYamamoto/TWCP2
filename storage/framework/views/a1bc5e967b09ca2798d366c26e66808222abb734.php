...
<div id="profile-edit-form" class="container" style="grid-template-columns:none;">
    ...
    <div class="row">
        <div class="bg-white"><!-- col-10 -->
            ...
            <form method="POST" action="<?php echo e(route('post.editProfile')); ?>" class="p-5" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group mb-0 mt-3 text-center">
                    <a href="<?php echo e(route('post.home')); ?>" class="btn btn-block btn-secondary mt-2">一覧に戻る</a>
                </div>
            </form>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.member', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/TWCP2/resources/views/admin/post/profile.blade.php ENDPATH**/ ?>