...
<body>
    ...
    <header id="header">
        <div id="slider">
            ...
            <ul id="user-btn">
                <li><a href="<?php echo e(route('showLogin')); ?>">ログイン</a></li>
                <li><a href="<?php echo e(route('showRegist')); ?>">会員登録</a></li>
    ...
    <main>
        ...
        <section id="box2" class="box" data-section-name="Landscape">
            <div class="box-area">
                ...
                <ul class="slider_width">
                    <li><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""></li>
                    <li><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""></li>
                    <li><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""></li>
                    <li><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""></li>
                    <li><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""></li>
        ...
        <section id="box3" class="box" data-section-name="post">
            <div class="box-area">
                ...
                <a href="<?php echo e(route('showLogin')); ?>" class="btnchangeline blurTrigger"><span>ログイン</span></a>
                <!--/box-area-->

            </div>
            <div id="gallery-2" class="hide-area">
                <p><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""><span class="caption">Woman 2001</span></p>
                <p><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""><span class="caption">Woman 2002</span></p>
                <p><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""><span class="caption">Woman 2003</span></p>
                <p><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""><span class="caption">Woman 2004</span></p>
                <p><img src="<?php echo e(asset('/images/画像/キッチン.jpeg')); ?>" alt=""><span class="caption">Woman 2005</span></p>
            </div>
            <!--/box-->
        </section>
