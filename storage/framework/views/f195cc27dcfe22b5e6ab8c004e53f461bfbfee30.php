        ...
        <div class="wallpaper">
            ...
            <nav class="navbar navbar-expand navbar-dark tempting-azure-gradient sticky-top">
                ...
                <div class="container d-flex justify-content-center px-4">
                    ...
                    <form method="GET" action="<?php echo e(route('operate.user')); ?>" class="search-form form-inline w-25 d-none d-md-flex">
                        <span></span>
                        <input class="form-control w-100" name="free_word" type="search" placeholder="投稿を検索" value="<?php echo e($freeWord ?? old('free_word')); ?>">
                    </form>
                    ...
                    <ul class="navbar-nav ml-auto d-none d-md-flex align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('register')); ?>"><i class="fas fa-user-plus mr-1"></i>ユーザー登録</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link mr-2" href="<?php echo e(route('login')); ?>"><i class="fas fa-sign-in-alt mr-1"></i>ログイン</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('post.regist')); ?>"><i class="fas fa-pen mr-1"></i>投稿する</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <!-- <img class="user-mini-icon  rounded-circle" src="<?php echo e(Auth::user()->icon_url); ?>"> -->
                        ...
                        <form id="mypage-button" method="POST" action="<?php echo e(route('post.profile')); ?>">
                            <?php echo csrf_field(); ?>
                        </form>
...
</html><?php /**PATH /Applications/MAMP/htdocs/TWCP2/resources/views/team/team.blade.php ENDPATH**/ ?>