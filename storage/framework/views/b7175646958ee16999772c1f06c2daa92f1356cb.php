...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo e(route('admin.regist')); ?>" class="btn btn-sm btn-outline-primary">新規作成</a>
    </div>
</div>
<div class="card">
...
<?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('admin.detail', $row->id)); ?>" class="btn btn-outline-primary">詳細</a>
                        <a href="<?php echo e(route('admin.update', $row->id)); ?>" class="btn btn-outline-primary">編集</a>
                        <a href="<?php echo e(route('admin.delete.confirm', $row->id)); ?>" class="btn btn-outline-primary">削除</a>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Nozomi/Documents/GitHub/TWCP2/resources/views/operate/administrator/list.blade.php ENDPATH**/ ?>