...
<body style="background-color: white;">
        ...
        <div class="header_content">
            ...
            <div class="header_list">
                <ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('showRegist')); ?>"><i class="fas fa-user-plus mr-1"></i>ユーザー登録</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link mr-2" href="<?php echo e(route('showLogin')); ?>"><i class="fas fa-sign-in-alt mr-1"></i>ログイン</a>
                    </li>
                    ...
                    <li class="has-child"><a href="#" class="nav-link"><?php echo e(Auth::user()->name); ?>さん</a>
                        <ul>
    ...
    <nav id="navi">
        <ul class="wrapper">
            ...
            <?php endif; ?>
            <?php if(auth()->guard()->check()): ?>
            <li><a href="<?php echo e(route('post.profile')); ?>">プロフィール</a></li>
            <li><a href="<?php echo e(route('post.regist')); ?>">記事作成</a></li>
            <li><a href="#">記事検索</a></li>
...
</html><?php /**PATH /Applications/MAMP/htdocs/TWCP2/resources/views/top.blade.php ENDPATH**/ ?>