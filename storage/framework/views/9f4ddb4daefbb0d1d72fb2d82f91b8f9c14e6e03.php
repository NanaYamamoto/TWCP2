            ...
            <nav id="f-nav">
                <div id="f-nav-list">
                    <ul id="g-navi" class="nav01c">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('post.register')); ?>"><i class="fas fa-user-plus mr-1"></i>ユーザー登録</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link mr-2" href="<?php echo e(route('post.login')); ?>"><i class="fas fa-sign-in-alt mr-1"></i>ログイン</a>
                        </li>
...
</html><?php /**PATH /Applications/MAMP/htdocs/TWCP2/resources/views/layouts/team/team.blade.php ENDPATH**/ ?>